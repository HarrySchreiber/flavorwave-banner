...
# banner = open('background.png')

# request = youtube.channelBanners().insert(media_body='Adjusted.png')
...
# fwuploadsRequest = youtube.playlistItems().list(
#     part='snippet',
#     playlistId='UUJRchI8cOT8hGQBDhBohGRw',
#     maxResults=100
# )

# nsfwfuploadsRequest = youtube.playlistItems().list(
#     part='snippet',
#     playlistId='UUMqylReKbMU8dnscaLmgj1w',
#     maxResults=100
# )
...
# uploadsStatistics = youtube.videos().list(
#     part='statistics',
#     id=[x['snippet']['resourceId']['videoId'] for x in uploadsRequest.execute()['items']]
# )

# print(sum([int(x['statistics']['viewCount']) for x in uploadsStatistics.execute()['items']]))

# dbWipe()

# for x in uploadsRequest.execute()['items']:
#     print(x)

# print([x['snippet']['resourceId']['videoId'] for x in uploadsRequest.execute()['items']])

# print(writeEntry(request.execute()))
...
#     background.paste(fig1, (55,435), fig1)
#     background.paste(fig2, (1643,435), fig2)
...
# YOUTUBE_API_KEY = "AIzaSyDNN_-ysIhe1fQjNAf2qaU7pXgwqJuaUls"
...
#     ret_dict = {
#         "Flavor Wave": res['items'][0]['statistics'],
#         "#7 Flavor Wave Fan": res['items'][1]['statistics']
#     }
#     return ret_dict
